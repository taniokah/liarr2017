...
where _j_ is the number of synset feature and _n_ is 1,000 as the amount of synset feature. _η<sub>j</sub>_ is the _j_ th synset feature score of a query image. _ξ_ <sub>i</sub>{_i_, _j_} is the _j_ th synset feature score of an indexed image.
